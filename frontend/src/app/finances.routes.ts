...
export const financesRoute: Route = {
  'path': 'app',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'export',
          loadComponent: () =>
            import('./pages/finances/transactions-page/export-transactions-page/export-transactions-page.component').then(
              m => m.ExportTransactionsPageComponent,
            ),
          data: {
            pageTitleKey: 'pageTitle.exportTransactions',
          },
        },
        {
          path: 'new',
