CREATE TABLE wallet_entry (
    ...
    CONSTRAINT fk_w_origin FOREIGN KEY (origin_id) REFERENCES wallet_item(id) ON DELETE CASCADE,
    CONSTRAINT fk_w_target FOREIGN KEY (target_id) REFERENCES wallet_item(id) ON DELETE CASCADE,
